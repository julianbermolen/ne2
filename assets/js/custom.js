$(document).ready(function(){
	$('#listadoEspecial').click(function(){
...
function eliminar(valor){
	$.ajax({
   type: "GET",
           url:"assets/php/eliminar.php?id="+valor
...
function examen(){
	...
	$('#examen').fadeToggle("slow",function () {
    $(this).delay(4000).fadeOut('slow');
});	
}
function audio(){

	$('#audio').fadeToggle("slow",function () {
    $(this).delay(4000).fadeOut('slow');
});	
}
function modInfo(){

	$('#modInfo').fadeToggle("slow",function () {
    $(this).delay(4000).fadeOut('slow');
});	
}
function resuelto(){

	$('#resuelto').fadeToggle("slow",function () {
    $(this).delay(4000).fadeOut('slow');
});	
}
function resume(){
...
(function($){
	...
	$(document).ready(function() {
		...
		$('#registro-form').submit(function(e) {
			...
			var name = $('#c_name').val();
			var apellido = $('#c_apellido').val();
			var email = $('#c_email').val();
			var pass = $('#c_pass1 ').val();
			var response = $('#registro-form .ajax-response');
